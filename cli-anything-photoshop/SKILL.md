...
本地来源：`/Users/hanyueyang/.codex/vendor/harness-anything-mac/photoshop-harness`

注意：上游 README 提到 macOS AppleScript/JXA 支持，但当前代码仍直接依赖 `win32com.client` 和 Windows COM。macOS 上只将本 skill 作为能力参考，不要声称已经可以执行 Photoshop 自动化。
