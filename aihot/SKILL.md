...
name: aihot
description: >
  AI HOT (aihot.virxact.com) 中文 AI 资讯查询 Skill。当用户想知道"今天 AI 圈有什么"、"AI 日报"、"AI
  HOT"、"AI 资讯"、"AI 热点"、"最近 AI"、"OpenAI/Anthropic/Google 最近发布了什么"、"AI hot
...
description_en: One-line access to today's curated AI models, products, industry
  news, and papers from aihot.virxact.com — no API key needed.
visibility: public
disable: true
---
