...
### 0. Confirm company template preference

- Before creating a new PPT/deck for the user, ask whether to use the company PPT template.
- Company template source: `/Users/hanyueyang/Desktop/公司PPT template.ppt`.
- Local skill asset copy: `/Users/hanyueyang/.codex/skills/ppt-generator-pro/assets/company-template/company-ppt-template.ppt`.
- Reusable template library: `/Users/hanyueyang/.codex/skills/ppt-generator-pro/assets/template-library/README.md`.
- Additional reusable templates:
  - `/Users/hanyueyang/.codex/skills/ppt-generator-pro/assets/template-library/business-blue-green-yellow-minimal.pptx`
  - `/Users/hanyueyang/.codex/skills/ppt-generator-pro/assets/template-library/red-navy-visual-tables.pptx`
- If the user confirms, use the company template's visual language, page hierarchy, typography, colors, header/footer conventions, and layout patterns as the default design basis.
- If the user declines the company template, offer the reusable template library when it fits the requested style; otherwise proceed with the requested style or the best-fit presentation design.
